...
/**
 * Interface para quem estiver usando este TextWatcher poder ter uma ação quando um erro de
 * validação acontecer.
 * Os métodos desta interface serão chamados quando for digitado um NOVO caracter e quando for
 * APAGADO um caracter.
 */
public interface EventoDeValidacao {
    ...
    /**
     * Invocado quando os números digitados estão parcialmente válidos. Quando o número estiver
     * completamente válido será chamado o callback {@link #totalmenteValido(String)}.
     *
     * @param valorAtual O valor após a digitação.
     */
